package com.starfish.notify.service.impl;

import com.starfish.notify.service.PrefixService;
import com.starfish.notify.service.TaskLock;
...
public class TaskLockImpl implements TaskLock {
    ...
    public Boolean lock(long time, long duration) {
        ...
        String key = prefixService.getString() + "starfish_notify_task_lock_" + format.format(new Date(time));
